...
Insight.prototype.getHeader = function(hash, cb) {
  var args = {
    method: 'GET',
    path: this.apiPrefix + '/header/' + hash,
    json: true,
  };
...
Insight.prototype.getHeaders = function(hash, cb) {
  var args = {
    method: 'GET',
    path: this.apiPrefix + '/headers/' + hash,
    json: true,
  };
...
Insight.prototype.getBlockTransactions = function(hash, cb) {
  var args = {
    method: 'GET',
    path: this.apiPrefix + '/txs/?block=' + hash,
    json: true,
  };
...
Insight.prototype.getFilteredBlockTransactions = function(hash, txid, cb) {
  var args = {
    method: 'GET',
    path: this.apiPrefix + '/txs/?txFilter=true&block=' + hash,
    json: true,
  };
...
Insight.prototype.getRawTx = function(txid, cb) {
  var args = {
    method: 'GET',
    path: this.apiPrefix + '/rawtx/' + txid,
    json: true,
  };
...
Insight.prototype.syncStatus = function(cb) {
  var args = {
    method: 'GET',
    path: this.apiPrefix + '/sync',
    json: true,
  };
